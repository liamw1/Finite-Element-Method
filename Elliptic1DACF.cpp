...
Elliptic1DACF::Elliptic1DACF(real1DFunction aFunc, real1DFunction cFunc, real1DFunction fFunc, real1DFunction naturalBoundaryCondition)
  : a(aFunc), c(cFunc), f(fFunc), naturalBC(naturalBoundaryCondition)
{
}

Vector Elliptic1DACF::solveSystem(const FEM1D& fem, const int n_gq) const
{
